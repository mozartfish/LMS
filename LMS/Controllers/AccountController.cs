...
namespace LMS.Controllers
{
    ...
    public class AccountController : CommonController
    {
        ...
        public string CreateNewUser(string fName, string lName, DateTime DOB, string SubjectAbbrev, string role)
        {
            ...
            using(Team69LMSContext db = new Team69LMSContext())
            {
        ...
        private string generateID()
        {
            while (true)
            {
                ...
                String num = rand.Next(0, 9999999).ToString("D7");
                
                //this is atrocious theres gotta be a better way to write this
                using(Team69LMSContext db = new Team69LMSContext())
                {
                    string id = "u" + num;
                    ...
                    else
                    {
                        ...
                        {
                            var adminquery = from a in db.Professors
                                            where a.UId == id
                                            select a;
